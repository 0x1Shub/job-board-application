...
export function CreateJobForm({companyAbout, companyLinkedInAccount, companyLocation, companyLogo, companyName, companyWebsite, companyXAccount} : iAppProps){
                            ...
                            <FormField
                                ...
                                render={({field}) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input placeholder="Enter your company's official website..." {...field} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )} 
                            ...
                            <FormField
                                ...
                                render={({field}) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input placeholder="Enter your company's LinkedIn profile URL..." {...field} />
                                        </FormControl>
                                    </FormItem>
                                )} 
                            />
                        ...
                        <FormField
                                ...
                                render={({field}) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Textarea 
                                                placeholder="Provide a brief overview of your company's mission, culture, and industry..." 
                                                {...field}
                                        ...
                                        <div>
                                            {
                                                field.value ? (
                                                    ...
                                                    <UploadDropzone endpoint="imageUploader"
                                                        ...
                                                        onUploadError={() => {
                                                            console.log("An error occurred while uploading. Please try again.");
                                                        }}
